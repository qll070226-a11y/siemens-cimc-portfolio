...
#define GD30AD3344_EXTREG_WRITE_CMD     0x8100U
#define GD30AD3344_EXTREG_READ_CMD      0x8106U
#define GD30AD3344_EXTREF_REGISTER_ADDR 0x0014U
#define GD30AD3344_EXTPROC_REGISTER_ADDR 0x0012U
#define GD30AD3344_EXTPROC_UNLOCK_VALUE 0xACCAU
#define GD30AD3344_EXTREF_ENABLE_BIT    0x0040U
...
extern GD30AD3344 GD30AD3344_InitStruct;
extern uint16_t GD30AD3344_RawCode;

/**
 * @brief Initialize the GD30AD3344 default configuration.
 */
...
/**
 * @brief Read one GD30AD3344 channel and convert the raw ADC code to voltage.
 * @param[in] CH ADC input channel.
 * @param[in] Ref PGA full-scale range.
